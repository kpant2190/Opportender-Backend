...
class QTendersScraper(BaseScraper):
    ...
    async def fetch(self):
        ...
        async with async_playwright() as p:
            ...
            # Public search page; adjust selectors as site evolves
            await page.goto("https://qtenders.epw.qld.gov.au/qtenders/", wait_until="domcontentloaded")
            try:
                await page.wait_for_selector("table", timeout=6000)
